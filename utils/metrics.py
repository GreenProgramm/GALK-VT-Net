...
def Train_index_gpu(image, label, classes,Type = 'train'):
    Type = Type
    metric_list = []
    start = time.time()
    # print(image.shape,label.shape)
...
def Train_index_gpu_no_background(image, label, classes,Type = 'train'):
    Type = Type
    metric_list = []
    start = time.time()
...
def Train_index_gd(output, label, classes):
...
def Train_index(image, label, classes,Type = 'train'):
    Type = Type
    metric_list = []
    # label = generate_label(label,classes)
    start = time.time()
