...
parser.add_argument('--data_root_path', type=str, default='/home/share/zym/Multi-organ_seg/all_data/kits19/Testing')
...
pretrained_path_swin = main_path + 'pretrained/Res_lsknet_attn_kits19.pth'
# ======================================parser args==========================================
...
with torch.no_grad():
    for index, batch in enumerate(test_loader):
        ...
        output = sliding_window_inference(image_input, (96, 96, 96), 16, model, overlap=0.5)
