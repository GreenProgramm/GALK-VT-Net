...
parser.add_argument('--cache_rate', default=1.0, type=float, help='The percentage of cached data in total 0.005')
...
parser.add_argument('--start_val', type=int, default=1000)
parser.add_argument('--val_epoch_gap', type=int, default=50)
parser.add_argument('--data_root_path', type=str, default='/home/share/zym/Multi-organ_seg/all_data/btcv/Training')

args = parser.parse_args()

'''
CUDA_VISIBLE_DEVICES=0 python train_3D_res_lsknet_attn_text_visual_btcv.py --loss_type CE+Dice_config_3D_res_lsknet_attn_text_visual_btcv_0
'''

#================================random seed===============================
seed = random.randint(0, 202500)
# seed = 1779
np.random.seed(seed)
...
pretrained_path_visual = main_path+'pretrained/Res_lsknet_attn_btcv.pth'
#================================ parser args===============================
