...
#from utils.metrics_sy import Train_index_sy, Train_index_sy_gpu, Train_index_sy_gpu_no_background
from utils.metrics import Train_index_gpu_no_background
...
def val(args,model,logger, epoch,checkpoint,main_data_path,\
    ...
    #             'Portal vein and splenic vein', 'Pancreas', 'Right adrenal gland','Left adrenal gland','Background']
