...
parser.add_argument('--dataset_type', type=str, default='KiTS19')
...
parser.add_argument('--val_epoch_gap', type=int, default=1) #50
parser.add_argument('--data_root_path', type=str, default='/home/share/zym/Multi-organ_seg/all_data/kits19/Training')

args = parser.parse_args()

'''
CUDA_VISIBLE_DEVICES=0 python train_3D_res_lsknet_attn_text_visual_kits19.py --loss_type CE+Dice_config_3D_res_lsknet_attn_text_visual_amos_0
'''
...
pretrained_path_text = main_path + 'pretrained/clip_text_kits19.pth'
pretrained_path_visual = main_path + 'pretrained/Res_lsknet_attn_kits19.pth'
# ================================ parser args===============================
...
macs, params = get_model_complexity_info(model, (in_chan, image_size, image_size, image_size), as_strings=True,
