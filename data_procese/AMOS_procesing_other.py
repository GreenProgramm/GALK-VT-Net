...
main_path = '/media/xd/date/muzhaoshan/AMOS2022/'
...
file_list_test = open(os.path.join(main_path, 'AMOS_test.txt')).readlines()
input_path = main_path + '/imagesTr/'
for i in range(3):
    if i==0:
        file_list = file_list_train
        save_file = 'Training_other'
    elif i==1:
        file_list = file_list_val
        save_file = 'Valing_other'
    elif i==2:
        file_list = file_list_test
        save_file = 'Testing_other'
