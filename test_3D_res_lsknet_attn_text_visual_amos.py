...
parser.add_argument('--num_classes', type=float, default=15)
...
parser.add_argument('--data_root_path', type=str, default='/home/share/zym/Multi-organ_seg/all_data/amos/Testing')

args = parser.parse_args()

'''
CUDA_VISIBLE_DEVICES=0 python test_3D_res_lsknet_attn_text_visual_amos.py  --loss_type CE+Dice_config_3D_res_lsknet_attn_text_visual_amos_0
'''
...
pretrained_path_swin = main_path+'pretrained/Res_lsknet_attn_amos.pth'
#======================================parser args==========================================
...
label_list=['Sple', 'Rkid', 'Lkid', 'Gall', 'Esop', 
                'Liver', 'Stom', 'Arot', 'InVC', 
                'Panc', 'RAGd','LAGd','Duod','Blad','Pros',"Avge"]
...
with torch.no_grad():
    ...
    for index, batch in enumerate(test_loader):
        ...
        output = sliding_window_inference(image_input, (96, 96, 96), 8, model,overlap = 0.75)
        ...
        #=================single indicators===============
        metric_ = Train_index_gpu_no_background(pred, label_input, num_classes,'train')    #single case indicators
